...
For detailed implementation of complex methods—including specific `data` strings for **SetOption**, **Ability** names, and **Targeting** modes—please refer to the [Official Documentation](https://github.com/DuxiiT/tds-autostrat/blob/main/docs.txt).
